...
export const russian: CatalogueIn<'ru'> = {
  ...
  'onboarding.feeling.action': 'Продолжить',
  'onboarding.feeling.choice.fine': 'Меня это устраивает',
  'onboarding.feeling.choice.hard': 'Тяжело, почти каждый месяц',
  'onboarding.feeling.choice.understand': 'Я хочу в этом разобраться',
  ...
  'onboarding.regularity.choice.unknown': 'Я пока не знаю',
  'onboarding.regularity.line.explains': 'Это меняет только то, как Emi объясняет ваш прогноз.',
  'onboarding.regularity.title': 'Регулярный',
  'onboarding.skip': 'Пропустить',
  'onboarding.step': 'Шаг {step} из {of}',
  'onboarding.today.action': 'Сохранить сегодня',
  'onboarding.today.choice.bloating': 'Вздутие',
  'onboarding.today.choice.calm': 'Спокойствие',
  'onboarding.today.choice.cramps': 'Спазмы',
  'onboarding.today.choice.fatigue': 'Усталость',
  'onboarding.today.choice.headache': 'Головная боль',
  'onboarding.today.choice.low-mood': 'Подавленность',
  'onboarding.today.line.encrypted': 'Emi шифрует это на телефоне.',
  'onboarding.today.line.skip': 'Этот шаг можно пропустить.',
  'onboarding.today.skip': 'Нечего добавить',
  'onboarding.today.title': 'Сегодня',
