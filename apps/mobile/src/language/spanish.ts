...
export const spanish: CatalogueIn<'es'> = {
  ...
  'onboarding.feeling.choice.hard': 'Es difícil, casi todos los meses',
  'onboarding.feeling.choice.understand': 'Quiero entenderlo',
  ...
  'onboarding.today.action': 'Guardar hoy',
  ...
  'onboarding.today.line.encrypted': 'Emi lo cifra en este teléfono.',
  'onboarding.today.line.skip': 'Puedes saltar esto.',
  'onboarding.today.skip': 'Nada que añadir',
  'onboarding.today.title': 'Hoy',
